...
public class MainActivity extends AppCompatActivity {
    ...
    public void nextWord() {
        ...
        if (mData != null) {
            ...
            mWord = mData.getString(mWordColumnIndex);
            mWordTV.setText(mWord);
    ...
    public void showDefinition() {
        ...
        mDefinition = mData.getString(mDefinitionColumnIndex);

        // TODO (4) Show the definition
        if (mData != null) {

            mDefinitionTV.setText(mDefinition);
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            // get index of "word" and "definition" columns
            ...
            // starts at -1 which can be considered the column titles
            // Cursor data starts at first row at index 0
            nextWord();
