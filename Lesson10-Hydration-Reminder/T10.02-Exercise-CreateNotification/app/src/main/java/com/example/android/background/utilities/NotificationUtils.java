...
public class NotificationUtils {
    ...
    private static final String CHANNEL_STRING_ID = "Channel named Arya";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_STRING_ID);
        builder
        ...
        if (version > Build.VERSION_CODES.JELLY_BEAN && version < Build.VERSION_CODES.O) {
