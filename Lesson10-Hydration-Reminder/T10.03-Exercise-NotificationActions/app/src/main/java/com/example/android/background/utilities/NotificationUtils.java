...
public class NotificationUtils {
    ...
    private static final int ACTION_DISMISS_PENDING_INTENT_ID = 1232;
    private static final int ACTION_INCREMENT_PENDING_INTENT_ID = 456456;
    ...
    public static Action ignoreReminderAction(Context context) {
        ...
        Action action = new Action(R.drawable.ic_cancel_black_24px, "No, thanks.", ignorePendingIntent);
    ...
    public static Action drinkWaterAction(Context context) {
        ...
        Action action = new Action(R.drawable.ic_local_drink_black_24px, "I did it!", drinkPendingIntent);
