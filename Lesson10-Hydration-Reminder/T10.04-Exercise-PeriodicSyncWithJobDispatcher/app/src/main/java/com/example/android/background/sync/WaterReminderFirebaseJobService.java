...
public class WaterReminderFirebaseJobService extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        // TODO (5) By default, jobs are executed on the main thread, so make an anonymous class extending AsyncTask called mBackgroundTask.
        mBackgroundTask = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] objects) {
                ...
                // when finished.
                ReminderTasks.executeTask(WaterReminderFirebaseJobService.this, ReminderTasks.ACTION_INCREMENT_REMINDER_COUNT);
