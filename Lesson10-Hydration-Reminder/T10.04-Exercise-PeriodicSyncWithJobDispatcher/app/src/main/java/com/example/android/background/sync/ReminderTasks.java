...
public class ReminderTasks {
    ...
    public static final String ACTION_INCREMENT_REMINDER_COUNT = "increment-reminder-count";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_INCREMENT_REMINDER_COUNT.equals(action)) {
            incrementReminderCount(context);
        }
    }
    ...
    private static void incrementReminderCount(Context context) {
