...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String JSON_QUERY_RESULTS_KEY = "results_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String results = savedInstanceState.getString(JSON_QUERY_RESULTS_KEY);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(JSON_QUERY_RESULTS_KEY, results);
