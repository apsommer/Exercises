...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to properly update the minSizeScale, assuming a proper numerical value is saved in shared preferences
