...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        // total minute until boarding
        long minToBoarding = info.getMinutesUntilBoarding();

        // just the hours until boarding, no remainder minutes
        long hoursToBoarding = TimeUnit.MINUTES.toHours(minToBoarding);

        // just the remainder minutes
        long remainderMinutesToBoarding = minToBoarding - TimeUnit.HOURS.toMinutes(hoursToBoarding);

        // format the final String based on provided regex.
        String boardingIn = getString(R.string.countDownFormat, hoursToBoarding, remainderMinutesToBoarding);
